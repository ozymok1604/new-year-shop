  ...
  return (
    <div>
      ...
      <div className={styles.description}>
        ...
        себе чекати. <b>Металева підставка</b> гарантує надійну стійкість, а лите гілля виглядає
        максимально природно й служить роками. Після свят ялинку легко сховати в{' '}
        <b>картонну коробку</b> — компактно, акуратно, без сміття та щорічних витрат.{' '}
        <b>Висота рахується разом з підставкою.</b>
      </div>
